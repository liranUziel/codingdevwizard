        ...
        <form action="" className='contact_form'>
            ...
            <div className="contact_form__wrapper">
               <div className="contact_form__fields">
                ...
                <div className="contact_form__text">
            ...
            <div className="social__link__wrapper">
                <a href="https://github.com/liranUziel" target="_blank" rel="noreferrer">
                ...
                <a href="https://www.linkedin.com/in/liran-uziel/" target='_blank' rel="noreferrer">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
